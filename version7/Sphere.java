...
public class Sphere {
    ...
    //contains data about any object of space for instance, sun, moon and their planets
    protected String nameOfBody;
    protected float radius;
    protected float distanceFromParent;
    protected float speedOfRotation;
    protected boolean hasRings = false;
    protected int numberOfMoons = 0;
    ...
    public Sphere(final int seqNo, final int depth) {

        if(seqNo != 11)        //Information about object if it's not a moon
        {
            this.nameOfBody = WorldData.getName(seqNo);
            this.radius = WorldData.getRadius(seqNo) / 2;
            this.distanceFromParent = WorldData.getDistance(seqNo);
            this.speedOfRotation = WorldData.getSpeed(seqNo);
            this.hasRings = WorldData.getRings(seqNo);
            this.numberOfMoons = WorldData.getMoons(seqNo);
        }
        else        //Information about object if it's a moon
        {
            this.nameOfBody = "Moon";
            this.radius = 0.15f;
            this.distanceFromParent = 1.5f;
            this.speedOfRotation = 1.7f;
            this.hasRings = false;
